function Set-TMServiceLogon {
    ...
    Param(
        ...
        [Parameter(Mandatory=$True,
                ...
                #This enables ByValue binding of pipeline input.
                #You can enable this for only one parameter per data type. Because $ComputerName is a [string] , 
                #it’s therefore the only [string] parameter we can mark as accepting pipeline input ByValue.
